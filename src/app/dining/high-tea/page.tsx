    ...
    <div className={styles.pageWrapper}>
      ...
      <section className={styles.featuredSection}>
        <div className={styles.container}>
          {[{"name":"Sea Lounge","location":"The Aura Mahal Palace, Mumbai","desc":"An iconic Mumbai experience. The Sea Lounge offers classical piano music, a lavish high tea buffet featuring both English classics and local street food delicacies, and breathtaking views of the Gateway of India and the Arabian Sea.","image":"/images/hotel_lobby_grand_1778416389976.png","highlights":["Arabian Sea Views","Live Piano Music","English & Local Delicacies"]},{"name":"The Emperor Lounge","location":"Aura Palace, New Delhi","desc":"An elegant, sun-lit setting perfect for informal meetings or leisurely afternoons. Offering bespoke tea blends, single-origin coffees from global estates, and a glass-enclosed pastry display featuring Parisian-style desserts.","image":"/images/fine_dining_restaurant_1778416112215.png","highlights":["Single-Origin Coffees","Parisian Pastries","Sun-lit Atrium"]}].map((feat: any, idx: number) => (
